...
function SuggestionMenu({onEdit, onDelete}: { onEdit: () => void; onDelete: () => void }) {
    ...
    return (
        <div className="suggestion-menu-container" ref={menuRef}>
            <button className="suggestion-menu-trigger" onClick={(e) => {
                e.stopPropagation();
                setIsOpen(!isOpen)
            }} title="More options">⋮
            </button>
        ...
        <div className="suggestions-view" ref={viewRef}>
            ...
            {sortedSuggestions.length === 0 ? (
                <div className="empty-suggestions">
                    <p>No suggestions yet. Add items to your shopping list to see smart suggestions based on your
                        shopping habits!</p>
                </div>
            ) : (
                      ...
                      >
                        ...
                        Added {suggestion.frequency}x • {formatLastAdded(suggestion.lastAdded)}
                                    ...
                                    <SuggestionMenu
                                        ...
                                        onDelete={() => {
                                            if (confirm(`Delete
                                            "${suggestion.text}" from suggestions?`)) {
